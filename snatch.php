...
$sources = [
    ...
    ['AGT', 'https://agt.minfin.gov.ao/PortalAGT/#!/', 'cambio table.table.table-condensed.table-blocked'],
    ['Atlantico', 'https://www.atlantico.ao/pt/particulares/Pages/home.aspx', '.carousel.carousel-movefour.slide .carousel-inner'],
    ['SOL', 'https://www.bancosol.ao/', 'table#CTRL_Cambios1_dynControl_quotationGrid'],
    ['BNI', 'http://www.bni.ao/pt/taxas/', '.col-xs-12.rates-table table.table'],
